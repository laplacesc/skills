 ...
 */
@Slf4j
@Service(ConfigConstant.LLM_DATA_API_PROCESS_SERVICE)
public class LLMFWDataApiProcessService implements ConfigProcessInterface {
    ...
    private void uploadLLMData(String sn, String markId) {
        try {
            ...
            String url = deviceInfoConfig.getHttpUrl() + "1.0/data/file/llm/rest_api/" + sn + "/" + markId;
