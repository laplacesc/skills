 ...
 */
public class WafFalsePositiveWebsecLogMocker extends IAvroMocker {

    public WafFalsePositiveWebsecLogMocker() {
        super();
    }
    ...
    public String getAvroFileName() {
        return "48e9c9ad5e0a4685725128406acadf66.avsc";
    }

    @Override
    public String getAvroMd5() {
        return "48e9c9ad5e0a4685725128406acadf66";
    }
    ...
    public byte[] createDataFile(DeviceInfoConfig device) throws Exception {
        ...
        genericRecord.put("matched_pattern", "SELECT 158 FROM");
        genericRecord.put("decoded_methods", "url");
