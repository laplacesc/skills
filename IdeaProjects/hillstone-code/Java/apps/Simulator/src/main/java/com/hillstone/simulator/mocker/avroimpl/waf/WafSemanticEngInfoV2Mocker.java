 ...
 */
public class WafSemanticEngInfoV2Mocker extends IAvroMocker {

    public WafSemanticEngInfoV2Mocker() {
        super();
    }
    ...
    public String getAvroFileName() {
        return "6a6b2e54934dc01ffec4cd86c954166e.avsc";
    }

    @Override
    public String getAvroMd5() {
        return "6a6b2e54934dc01ffec4cd86c954166e";
    }
    ...
    public byte[] createDataFile(DeviceInfoConfig device) throws Exception {
        ...
        genericRecord.put("xss_black_field", "");
        genericRecord.put("xss_detect_state", 10);
        genericRecord.put("matched_pattern", "");
        genericRecord.put("decoded_methods", "");
