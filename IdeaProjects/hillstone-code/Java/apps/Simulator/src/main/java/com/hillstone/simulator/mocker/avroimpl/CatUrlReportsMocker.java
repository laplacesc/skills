 ...
 */
public class CatUrlReportsMocker extends IAvroMocker {


    public CatUrlReportsMocker() {
        super();
    }
    ...
    public String getAvroFileName() {
        return "357aed38e16a604ae8d00193eece82d2.avsc";
    }

    @Override
    public String getAvroMd5() {
        return "357aed38e16a604ae8d00193eece82d2";
    }
    ...
    public byte[] createDataFile(DeviceInfoConfig device) throws Exception {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            ips_status_idp_scan_algor.put("catid",  i);
