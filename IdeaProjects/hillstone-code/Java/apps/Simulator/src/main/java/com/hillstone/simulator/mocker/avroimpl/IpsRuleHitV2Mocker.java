 ...
 * @description
 */
public class IpsRuleHitV2Mocker extends IAvroMocker {
    public IpsRuleHitV2Mocker() {
        super();
    }
    ...
    public byte[] createDataFile(DeviceInfoConfig device) throws Exception {
        ...
        GenericArray<GenericRecord> ipsBufferStats = new GenericData.Array<>(1, schema.getField("ips_buffer_stats").schema());
    ...
    public String getAvroFileName() {
        return "fd846603e8e69bc4957e97a04b7741d2.avsc";
    }
    ...
    public String getAvroMd5() {
        return "fd846603e8e69bc4957e97a04b7741d2";
    }
}
