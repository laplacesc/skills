...
/**
 * @author xjhuang
 * @date create in 9:10 2024/4/14
 * @description
 */
@Service(ConfigConstant.DEVICE_FULL_CONFIG_PROCESS_SERVICE)
@Slf4j
public class DeviceFullConfigProcessService implements ConfigProcessInterface {
    ...
    public void runConfigProcess(MessageObject mo) {
        ...
        uploadDeviceFullConfigFile(sn, taskId);
    ...
    private void uploadDeviceFullConfigFile(String sn, String taskId){
        String url = deviceInfoConfig.getHttpUrl() + "1.0/data/file/cloud_platform_configuration/" + ConfigConstant.SYNC_CONFIG_FILE + "/" + sn;


        MultiValueMap<String, Object> form = new LinkedMultiValueMap<>();

        InputStream ins = this.getClass()
                .getResourceAsStream("/config/full_xml_config_20231204095535.conf.gz");
        ...
        ByteArrayResource fileResource = new ByteArrayResource(data) {
            ...
            public String getFilename() {
                return "full_xml_config_20231204095535.conf.gz"; // 设置文件名
            }
        };
