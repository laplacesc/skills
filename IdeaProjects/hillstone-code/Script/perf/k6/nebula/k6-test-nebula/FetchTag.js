...
var graph_option = {
  ...
  output: "output/20241226203336/output500_FetchTag.csv",
  username: "root",
  password: "nebula",
  max_size: 2000,
};
...
export default function (data) {
  ...
  let ngql = "FETCH PROP ON Person {0} YIELD Person.firstName, Person.lastName, Person.gender, Person.birthday, Person.creationDate, Person.locationIP, Person.browserUsed".format(d);
