...
var graph_option = {
  ...
  output: "output/20241226203336/output500_InsertVertexScenario.csv",
  username: "root",
  password: "nebula",
  max_size: 2000,
};
...
export default function (data) {
  ...
  let ngql = "INSERT VERTEX Person(firstName, lastName, gender, birthday, creationDate, locationIP, browserUsed) VALUES {0}:(\"{1}\", \"{2}\", \"{3}\", \"{4}\", datetime(\"{5}\"), \"{6}\", \"{7}\")".format(d);
