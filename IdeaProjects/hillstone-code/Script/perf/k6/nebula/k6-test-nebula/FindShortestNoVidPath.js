...
var graph_option = {
  ...
  space: "ldbc",
  csv_path: "target/data/test_data/social_network/dynamic/person_knows_person.csv",
  pool_policy: "connection",
  csv_delimiter: "|",
  csv_with_header: true,
  output: "output/20241226203336/output500_FindShortestNoVidPath.csv",
  username: "root",
  password: "nebula",
  max_size: 2000,
};
...
export default function (data) {
  ...
  let ngql = "FIND SHORTEST PATH FROM {0} TO -1 OVER * YIELD path as p".format(d);
