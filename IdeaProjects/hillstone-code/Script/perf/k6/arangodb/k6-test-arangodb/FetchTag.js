...
const PERSON = new SharedArray('open csv', function () {
...
export default function () {
    let person1 = PERSON[Math.floor(Math.random() * PERSON.length)];
    const query = {
